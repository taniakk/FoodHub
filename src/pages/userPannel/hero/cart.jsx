function Cart(){
    return(
        <div className=" h-auto  w-full flex flex-col items-center justify-center py-30">
            <div className="h-[280px] lg:h-[60vh]  w-[280px] lg:w-[90%] bg-[url('/images/cartimg.jpg')] bg-cover
             bg-center rounded-full lg:rounded-b-full shadow-2xl">

            </div>
            {/* box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; */}
            <h1 className="text-[60px] text-shadow-md text-shadow-gray-700 p-6 font-bold text-amber-900">🛒C A R T🍔</h1>
            <div className="lg:h-[50vh] lg:my-10  w-full flex flex-col lg:flex-row items-center justify-center gap-4 ">
                ...
                <div className="shadow-2xl lg:h-[40vh] py-4 lg:py-0  w-[70%] mt-6 lg:mt-0 lg:w-[25%] rounded-2xl flex flex-col items-center justify-evenly">
                    ...
                    <div className="flex flex-col items-center justify-evenly  w-[90%] text-gray-600 gap-2">
                        ...
                        <button className="text-[25px] border px-6 py-2  my-6 bg-green-800 text-white rounded-[40px]
                         hover:bg-white hover:text-black">Proceed to Pay</button>
                        </div>
                </div>
